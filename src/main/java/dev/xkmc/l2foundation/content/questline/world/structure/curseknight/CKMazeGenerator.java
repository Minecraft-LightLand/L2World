...
public class CKMazeGenerator {
	...
	public static void addPieces(StructureTemplateManager manager, BlockPos pos, List<StructurePiece> children, WorldgenRandom r, MazeConfig conf) {
	...
	private static void addEdges(StructureTemplateManager manager, List<StructurePiece> children, BlockPos pos, int x, int z, Rotation rot, boolean door) {
	...
	private static void addCorners(StructureTemplateManager manager, List<StructurePiece> children, BlockPos pos, int x, int z, Rotation rot) {
