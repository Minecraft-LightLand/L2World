package dev.xkmc.l2foundation.content.questline.common.mobs;
...
public class BaseMonster<T extends BaseMonster<T>> extends Monster {
	...
	@Override
	protected final void populateDefaultEquipmentSlots(RandomSource random, DifficultyInstance difficulty) {
	...
	@Override
	protected final void populateDefaultEquipmentEnchantments(RandomSource random, DifficultyInstance difficulty) {
