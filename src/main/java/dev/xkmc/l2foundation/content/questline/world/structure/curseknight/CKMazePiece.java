...
public class CKMazePiece extends TemplateStructurePiece {
	...
	public CKMazePiece(StructureTemplateManager manager, CKMazeGenerator.CellInstance ins, BlockPos pos, ShiftType shift, boolean inner) {
		this(manager, ins, makeSettings(inner, ins.rot(), ins.mir(), shift), pos, shift);
	}

	private CKMazePiece(StructureTemplateManager manager, CKMazeGenerator.CellInstance ins, StructurePlaceSettings settings, BlockPos pos, ShiftType shift) {
	...
	public CKMazePiece(StructureTemplateManager manager, CompoundTag tag) {
