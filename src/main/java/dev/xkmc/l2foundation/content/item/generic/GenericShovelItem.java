...
public class GenericShovelItem extends ShovelItem implements GenericTieredItem {

	private final ExtraToolConfig config;

	public GenericShovelItem(Tier tier, int damage, float speed, Properties prop, ExtraToolConfig config) {
